...
const MordexelDiagram = dynamic(() => import("../MordexelDiagram/MordexelDiagram"), {
  loading: DiagramLoadingState,
});
const SolanaToolsDiagram = dynamic(() => import("../SolanaToolsDiagram/SolanaToolsDiagram"), {
  loading: DiagramLoadingState,
});
const StrategyDashboardDiagram = dynamic(
  () => import("../StrategyDashboardDiagram/StrategyDashboardDiagram"),
  { loading: DiagramLoadingState },
);
const TelegramIntelligenceDiagram = dynamic(
  () => import("../TelegramIntelligenceDiagram/TelegramIntelligenceDiagram"),
  { loading: DiagramLoadingState },
);
const TelegramNotifyDiagram = dynamic(
  () => import("../TelegramNotifyDiagram/TelegramNotifyDiagram"),
  { loading: DiagramLoadingState },
);
...
const VoitodoDiagram = dynamic(() => import("../VoitodoDiagram/VoitodoDiagram"), {
  loading: DiagramLoadingState,
});
